...
(function() {
        ...
        window.__processVideo = function(videoElement) {
                ...
                html = '<object type="application/x-shockwave-flash" width="100%" height="100%">' + ' <param name="flashvars" value="' + flashvars + '" />' + ' <param name="movie" value="flowplayer-3.1.1.swf" />' + '</object>';
                div.innerHTML = html;
