     ...
     function expandNav() {
     	...
     	//only expand menu on hover on screens bigger than 640px	
  		if(viewportSize.getWidth() > 640) {
	  		$('.home #nav-expander').on('mouseenter', function(){
     	...
     	//only expand menu on click on screens smaller than 640px	
   		...
   		//smooth scrolling when clicking an anchor that links to a section
  	...
  	/* ==========================================================================
        Expand Testimonials on Modal 
     ========================================================================== */ 
     function expandTestimonials() {
		    $('.cd-see-all').on('click', function(){
		        $('.cd-testimonials-all').addClass('is-visible');
		    });
		    /* Close the  Testimonials on Modal */ 
        ...
        Remove anchors
     	...
     	function removeAnchors(){
	     	$('#nav-expander, .arrow, .load-more').on('click', function(e){
	     		e.preventDefault();
	     	});
     	}
